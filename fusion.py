...
############## FUNCIONS NO IMPLEMENTADES AL DOCOPT
def extract_audio(input_file, output_file):
    """
    Extrae el audio de un archivo de video.

    input_file: Ruta del archivo de entrada.
    output_file: Ruta del archivo de salida de audio.
    """
    ...
    if audio_stream:
        ...
        output_file = f"{output_file}.{codec_name}"

        ffmpeg.input(input_file).output(output_file, acodec='copy').run()
    else:
        print("No se encontró ningún flujo de audio en el archivo de video.")
